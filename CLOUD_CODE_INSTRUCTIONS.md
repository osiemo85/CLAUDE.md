...
## Task sizing â€” triage before spending tokens

Start every task with a short triage block:

```
Size: small | medium | large â€” why
Tests: local checks | full suite â€” why
Agents: solo | fan-out â€” why
Branch: <branch name>
```
...
## Branching â€” one session, one worktree, one branch
...
## The two machine spaces â€” read this before doing anything
...
### Tests and evals â€” every time, no exceptions
...
## Fan-out + harsh critic â€” for large work
...
- **DONE** â€” The requested work is complete and relevant checks passed.
- **DONE_WITH_CONCERNS** â€” The work is complete but a stated risk, limitation, or skipped check remains.
- **BLOCKED** â€” Progress is stopped by a technical failure or external dependency.
- **NEEDS_CONTEXT** â€” Requirements, access, or expected behavior are missing.
...
## After every task â€” commit, push, restart
